...
![Histogram](../images/handson/chap2_hist.png "Histogram")
...
![Correlation](../images/handson/chap2_correlation.png "Correlation")

#### Geographical 

If the data has geographical or geometric nature, plotting against the nature shape of the data will be very helpful too. 

![Geographical](../images/handson/chap2_geographical.png "Geographical")
...
This article is part of a series of summaries on the book *Hands-On Machine Learning with Scikit-Learn and TensorFlow* from O'Reilly. The source codes are from either the book itself or this GitHub repository https://github.com/ageron/handson-ml.

I strongly recommend this book for machine learning beginners. It introduces the machine learning with two of the most popular machine learning tools, TensorFlow and Scikit-Learn. What's more, it does not require deep maths and programming knowledge as pre-requisites. All you need to know is the very basic of Python.
